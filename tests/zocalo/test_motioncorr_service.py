        ...
        message={
            "parameters": {
                ...
                "command": (
                    ...
                    "-PixSize 0.1 -FmDose 1.0 -Gain gain.mrc -RotGain 1 -FlipGain 1 "
                    "-Dark dark -UseGpus 1 -SumRange sum1 sum2 -Iter 1 -Tol 1.1 "
                    "-Throw 1 -Trunc 1 -FmRef 1 -Kv 300 -FmIntFile fm_int_file "
                    "-Mag mag1 mag2 -FtBin 1.1 -Serial 1 -InSuffix mrc -EerSampling 1 "
                    "-OutStack 1 -Bft 500 150 -Group 1 -DetectFile file "
                    "-ArcDir arc_dir -InFmMotion 1 -SplitSum 1"
                ),
                "stdout": "stdout",
                "stderr": "stderr",
                "results": {
